...
Deployer.prototype = {
  ...
  deploy: function (theme) {
    ...
    return this.request(url('customize_api', 'blog', this.options.blog), 'POST', this.deploy_request_options(theme));
  },
  ...
  request: function (uri, method, options) {
    ...
    return when.promise(function(resolve, reject) {
      __this.emitter.emit('init', method.toLowerCase() + 'ing ' + uri);
